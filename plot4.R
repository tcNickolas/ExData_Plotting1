...
par(mfrow = c(2,2));
plot(data$DateTime, data$Global_active_power, main = "", xlab = "", ylab = "Global Active Power", type="n");
lines(data$DateTime, data$Global_active_power);

plot(data$DateTime, data$Voltage, main = "", xlab = "datetime", ylab = "Voltage", type="n");
lines(data$DateTime, data$Voltage);

plot(data$DateTime, data$Sub_metering_1, main = "", xlab = "", ylab = "Energy sub metering", type="n");
...
plot(data$DateTime, data$Global_reactive_power, main = "", xlab = "datetime", ylab = "Global_reactive_power", type="n");
